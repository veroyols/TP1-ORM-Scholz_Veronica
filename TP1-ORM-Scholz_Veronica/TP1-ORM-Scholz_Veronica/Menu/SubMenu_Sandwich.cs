...
{
    public class SubMenu_Sandwich : MenuTemplate
    {
        public SubMenu_Sandwich() { }

        override public void ShowMenu()
        {
            Console.WriteLine("                      ------------------");
            Console.WriteLine("                     | AGREGAR SANDWICH |");
            Console.WriteLine("                      ------------------");
            Console.WriteLine("             1. Hamburguesa");
            Console.WriteLine("             2. Sandwich de pollo cesar");
        ...
        override public bool ChooseOpt(int opt)
        {
            switch (opt)
            {
                ...
                case 0:
                    Console.Clear();
                    Console.WriteLine("\n               -------------------------------");
                    Console.WriteLine("              | Saliendo de SubMenu_Sandwich. |");
                    Console.WriteLine("               -------------------------------");
                    return false;
                case 1:
                    Console.WriteLine("                  -------------");
