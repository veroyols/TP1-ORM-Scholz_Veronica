...
{
    public class SubMenu_Ensalada : MenuTemplate
    {
        public SubMenu_Ensalada() { }

        override public void ShowMenu()
        {
            Console.WriteLine("                      ------------------");
            Console.WriteLine("                     | AGREGAR ENSALADA |");
            Console.WriteLine("                      ------------------");
            Console.WriteLine("             1. Lechuga y cebolla");
            Console.WriteLine("             2. Tomate y zanahoria");
        ...
        override public bool ChooseOpt(int opt)
        {
            switch (opt)
            {
                ...
                case 0:
                    Console.Clear();
                    Console.WriteLine("\n               ----------------------------");
                    Console.WriteLine("              | Saliendo de SubMenu_Ensalada. |");
                    Console.WriteLine("               ----------------------------");
                    return false;
                case 1:
                    Console.WriteLine("                  -------------");
