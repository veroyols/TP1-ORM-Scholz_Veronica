...
{
    public class SubMenu_Pastas : MenuTemplate
    {
        public SubMenu_Pastas() { }

        override public void ShowMenu()
        {
            Console.WriteLine("                      ----------------");
            Console.WriteLine("                     | AGREGAR PASTAS |");
            Console.WriteLine("                      ----------------");
            Console.WriteLine("             1. Noquis con Bolognesa");
            Console.WriteLine("             2. Fideos con Salsa Cuatro Quesos");
            Console.WriteLine("             3. Sorrentinos (jamon y queso) con Salsa Filetto");
        ...
        override public bool ChooseOpt(int opt)
        {
            switch (opt)
            {
                ...
                case 0:
                    Console.Clear();
                    Console.WriteLine("\n               ----------------------------");
                    Console.WriteLine("              | Saliendo de SubMenu_Pastas. |");
                    Console.WriteLine("               ----------------------------");
                    return false;
                case 1:
                    Console.WriteLine("                  -------------");
